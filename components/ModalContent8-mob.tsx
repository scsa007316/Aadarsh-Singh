  ...
  return (
    ...
    <div>
            ...
            The Rank-Nullity theorem states,           
              ...
              <div style={{ textAlign: 'center', color:'black', border: '', padding: '10px', margin: '40px' }}>
            ...
            <BlockMath math="b_{i,j} = \frac{a_{i,j}}{g_f(i,j)}" />
        
            </div>

            <p style={{ fontSize: '1.2rem', color:'black', fontWeight: '600', marginBottom: '10px' }}>
           The implications of this transformation on the eigenvectors is also considered.
            Here is the <a href="https://inspirehep.net/literature/2828879" style={{ textDecoration: 'underline' }}>link</a> to the e-print.
            </p>
        <button
  onClick={closeModal}
  style={{
